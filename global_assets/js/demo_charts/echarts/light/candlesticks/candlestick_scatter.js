/* ------------------------------------------------------------------------------
 *
 *  # Echarts - Candlestick with scatter example
 *
 *  Demo JS code for candlestick chart with scatter [light theme]
 *
 * ---------------------------------------------------------------------------- */
...
var EchartsCandlestickScatterLight = function() {
    ...
    // Candlestick chart with scatter
    var _candlestickScatterLightExample = function() {
    ...
    return {
        init: function() {
            _candlestickScatterLightExample();
        }
    }
}();
...
document.addEventListener('DOMContentLoaded', function() {
    EchartsCandlestickScatterLight.init();
});
