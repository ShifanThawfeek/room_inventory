 ...
 *
 *  Demo JS code for candlestick chart with scatter [dark theme]
 *
 * ---------------------------------------------------------------------------- */
...
var EchartsCandlestickScatterDark = function() {
    ...
    var _candlestickScatterDarkExample = function() {
    ...
    return {
        init: function() {
            _candlestickScatterDarkExample();
        }
    }
}();
...
document.addEventListener('DOMContentLoaded', function() {
    EchartsCandlestickScatterDark.init();
});
