...
var WarningPalette = function() {
    ...
    var _componentPopups = function() {
        ...
        $('[data-popup=tooltip-custom]').tooltip({
            template: '<div class="tooltip"><div class="arrow border-warning"></div><div class="tooltip-inner bg-warning text-white"></div></div>'
        });
        ...
        $('[data-popup=popover-custom]').popover({
            trigger: 'hover',
            template: '<div class="popover border-warning"><div class="arrow"></div><h3 class="popover-header bg-warning text-white"></h3><div class="popover-body"></div></div>'
        });
        ...
        $('[data-popup=popover-solid]').popover({
            trigger: 'hover',
            template: '<div class="popover bg-warning border-warning text-white"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body text-white"></div></div>'
        });
    };
