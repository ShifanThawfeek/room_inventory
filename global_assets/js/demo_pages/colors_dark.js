/* ------------------------------------------------------------------------------
 *
 *  # Dark color palette showcase
 *
 *  Demo JS code for colors_dark.html page
 *
 * ---------------------------------------------------------------------------- */
...
var DarkPalette = function() {
    ...
    var _componentNoty = function() {
        ...
        $('.noty-launch').on('click', function() {
            new Noty({
                layout: 'topRight',
                theme: ' alert bg-dark text-white p-0',
    ...
    var _componentPopups = function() {
        ...
        $('[data-popup=tooltip-custom]').tooltip({
            template: '<div class="tooltip"><div class="arrow border-dark"></div><div class="tooltip-inner bg-dark text-white"></div></div>'
        });
        ...
        $('[data-popup=popover-custom]').popover({
            trigger: 'hover',
            template: '<div class="popover border-dark"><div class="arrow"></div><h3 class="popover-header bg-dark text-white"></h3><div class="popover-body"></div></div>'
        });
        ...
        $('[data-popup=popover-solid]').popover({
            trigger: 'hover',
            template: '<div class="popover bg-dark border-dark text-white"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body text-white"></div></div>'
        });
    };
