...
var IndigoPalette = function() {
    ...
    var _componentPnotify = function() {
        ...
        $('.pnotify-launch').on('click', function () {
            new PNotify({
                ...
                icon: 'icon-info22',
                addclass: 'bg-indigo border-indigo text-white'
            });
        });
    };
    ...
    var _componentPopups = function() {
        ...
        $('[data-popup=tooltip-custom]').tooltip({
            template: '<div class="tooltip"><div class="arrow border-indigo"></div><div class="tooltip-inner bg-indigo text-white"></div></div>'
        });
        ...
        $('[data-popup=popover-custom]').popover({
            trigger: 'hover',
            template: '<div class="popover border-indigo"><div class="arrow"></div><h3 class="popover-header bg-indigo text-white"></h3><div class="popover-body"></div></div>'
        });
        ...
        $('[data-popup=popover-solid]').popover({
            trigger: 'hover',
            template: '<div class="popover bg-indigo border-indigo text-white"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body text-white"></div></div>'
        });
    };
