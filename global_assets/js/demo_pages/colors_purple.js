...
var PurplePalette = function() {
    ...
    var _componentPnotify = function() {
        ...
        $('.pnotify-launch').on('click', function () {
            new PNotify({
                ...
                icon: 'icon-info22',
                addclass: 'bg-purple border-purple text-white'
            });
        });
    };
    ...
    var _componentPopups = function() {
        ...
        $('[data-popup=tooltip-custom]').tooltip({
            template: '<div class="tooltip"><div class="arrow border-purple"></div><div class="tooltip-inner bg-purple text-white"></div></div>'
        });
        ...
        $('[data-popup=popover-custom]').popover({
            trigger: 'hover',
            template: '<div class="popover border-purple"><div class="arrow"></div><h3 class="popover-header bg-purple text-white"></h3><div class="popover-body"></div></div>'
        });
        ...
        $('[data-popup=popover-solid]').popover({
            trigger: 'hover',
            template: '<div class="popover bg-purple border-purple text-white"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body text-white"></div></div>'
        });
    };
