...
var ColorPicker = function() {
    ...
    var _componentColorPicker = function() {
        ...
        $('.colorpicker-container-class').spectrum({
            containerClassName: 'bg-secondary text-white'
        });

        // Replacer color
        $('.colorpicker-replacer-class').spectrum({
            replacerClassName: 'bg-secondary text-white',
        });
        ...
        // Define element for state toggle
        var toggleState = document.querySelector('#enable_picker');
